...
import { useRouter } from 'next/navigation'; // or next/router if you're using that
...
export default function LoginPage() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      console.log(data)
      // The response from your login route returns: { token, userId, email }
      ...
      // We're constructing a user object with id, email, and token.
